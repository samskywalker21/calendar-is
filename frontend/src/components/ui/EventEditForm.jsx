...
const ORD_OPTIONS = [
	{ value: 'RESDRU', label: 'ORD - RESDRU' },
	{ value: 'Legal/PACD', label: 'ORD - Legal/PACD' },
	{ value: 'CHEPU', label: 'ORD - CHEPU' },
	{ value: 'HFDU', label: 'ORD - HFDU' },
	{ value: 'Infra', label: 'ORD - Infra' },
	{ value: 'CMU', label: 'ORD - CMU' },
	{ value: 'Research', label: 'ORD - Research' },
	{ value: 'ICTU', label: 'ORD - ICTU' },
];

const LHSD_OPTIONS = [
	{ value: 'LHSDC', label: 'LHSD - LHSDC' },
	{ value: 'DMU', label: 'LHSD - DMU' },
	{ value: 'NCDC', label: 'LHSD - NCDC' },
	{ value: 'FHC', label: 'LHSD - FHC' },
	{ value: 'IDC', label: 'LHSD - IDC' },
	{ value: 'EOH', label: 'LHSD - EOH' },
	{ value: 'PDOHO BUKIDNON', label: 'LHSD - PDOHO BUKIDNON' },
	{ value: 'PDOHO CAMIGUIN', label: 'LHSD - PDOHO CAMIGUIN' },
	{ value: 'PDOHO LANAO DEL NORTE', label: 'LHSD - PDOHO LANAO DEL NORTE' },
	{
		value: 'PDOHO MISAMIS OCCIDENTAL',
		label: 'LHSD - PDOHO MISAMIS OCCIDENTAL',
	},
	{ value: 'PDOHO MISAMIS ORIENTAL', label: 'LHSD - PDOHO MISAMIS ORIENTAL' },
	{ value: 'CDOHO CAGAYAN DE ORO', label: 'LHSD - CDOHO CAGAYAN DE ORO' },
	{ value: 'CDOHO ILIGAN', label: 'LHSD - CDOHO ILIGAN' },
];

const MSD_OPTIONS = [
	{ value: 'Personnel', label: 'MSD - Personnel' },
	{ value: 'HRDU', label: 'MSD - HRDU' },
	{ value: 'Accounting', label: 'MSD - Accounting' },
	{ value: 'Budget', label: 'MSD - Budget' },
	{ value: 'Cashier', label: 'MSD - Cashier' },
	{ value: 'Planning', label: 'MSD - Planning' },
	{ value: 'Procurement', label: 'MSD - Procurement' },
	{ value: 'Supply', label: 'MSD - Supply' },
	{ value: 'Transport/GSS', label: 'MSD - Transport/GSS' },
	{ value: 'Records', label: 'MSD - Records' },
];

const EventEditForm = ({ id }) => {
	const { control, handleSubmit, setValue } = useForm();
	const [selectedDiv, setSelectedDiv] = useState('ORD/ARD');
	const eventFunction = useContext(EventContext);
	const nav = useNavigate();
	const openNotif = useNotifStore((state) => state.openNotif);
	...
	useEffect(() => {
		eventFunction
			...
			.then((data) => {
				...
				setValue('csuHead', event.extendedProps['csuHead']);
				setValue('participants', event.extendedProps['participants']);
				setSelectedDiv(event.extendedProps['division']);
			})
			.catch(() => {
				throw new Error('It does not work');
			});
					...
					<FormControl>
						...
						<Controller
							...
							render={({ field }) => (
								...
								>
									{selectedDiv === 'ORD/ARD' &&
										renderSelectOptions(ORD_OPTIONS)}
									{selectedDiv === 'LHSD' &&
										renderSelectOptions(LHSD_OPTIONS)}
									{selectedDiv === 'MSD' &&
										renderSelectOptions(MSD_OPTIONS)}
									{selectedDiv === 'RLED' && (
										<MenuItem value='RLED'>RLED</MenuItem>
									)}
								</Select>
